    ...
    <header className="sticky top-0 z-50 left-0 right-0 px-4 md:px-0 bg-white/80 backdrop-blur-sm border-b border-gray-200 z-50">
     ...
     <div className="container mx-auto ">
      ...
      <div className="flex items-center gap-4">
        <SignedIn>
            <Link href="/manage-plan" className="text-sm font-medium text-gray-500">
        ...
        <SignedOut>
          <SignInButton>
            <Button variant="ghost" className="bg-gradient-to-r from-blue-600 to-blue-400 text-transparent bg-clip-text">Login</Button>
          </SignInButton>
        </SignedOut>
      </div>
      </div>
